...
local Skin = {
	...
	colors = {
		...
		-- UI 基础配色
		ui = {
			foreground = { 1.0, 1.0, 1.0, 1.0 },       -- 默认前景色 (用于文本等)
			disabled = { 0.35, 0.35, 0.35, 1.0 },      -- 禁用状态色
			border = { 0.3, 0.3, 0.3, 1.0 },           -- 边框色
			highlight = { 0.4, 0.8, 1.0, 1.0 },        -- 高亮/信息色
			danger = { 1.0, 0.2, 0.2, 1.0 },           -- 危险/错误/静音色
			warning = { 1.0, 1.0, 0.0, 1.0 },          -- 警告色
			button = {
				transparent = { 0.0, 0.0, 0.0, 0.0 },  
				transparent_hovered = { 1.0, 1.0, 1.0, 0.1 },
				transparent_active = { 1.0, 1.0, 1.0, 0.15 },
				normal = { 0.3, 0.3, 0.3, 1.0 },       
				normal_hovered = { 0.35, 0.35, 0.35, 1.0 },
				normal_active = { 0.4, 0.4, 0.4, 1.0 },
				sidebar_active = { 0.25, 0.25, 0.25, 1.0 },
				disabled_bg = { 0.15, 0.15, 0.15, 0.95 } 
			}
		},
