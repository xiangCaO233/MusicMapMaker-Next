return {
	...
	["ui.settings.editor.shortcuts"] = "自定义快捷键",
	["ui.settings.editor.shortcuts.tool_move"] = "抓取工具",
	["ui.settings.editor.shortcuts.tool_marquee"] = "选取工具",
	["ui.settings.editor.shortcuts.tool_draw"] = "绘制工具",
	["ui.settings.editor.shortcuts.tool_color_brush"] = "配色笔刷",
	["ui.settings.editor.shortcuts.tool_color_eraser"] = "配色橡皮",
	["ui.settings.editor.shortcuts.mirror"] = "镜像",
	["ui.settings.editor.shortcuts.mirror_paste"] = "镜像粘贴",
	["ui.settings.editor.shortcuts.toggle_reverse_scroll"] = "切换反转滚动",
	["ui.settings.editor.shortcuts.toggle_scroll_snap"] = "切换滚动磁吸",
	["ui.settings.editor.shortcuts.toggle_snap_floor"] = "切换吸附向下取整",
	["ui.settings.editor.shortcuts.toggle_scroll_timing_mapping"] = "切换 SCROLLTIMING 映射",
	["ui.settings.editor.shortcuts.toggle_beat_lines"] = "切换分拍线",
	["ui.settings.editor.shortcuts.toggle_stop_playback_on_scroll"] = "切换滚动停止播放",
	["ui.settings.editor.shortcuts.toggle_hit_sfx"] = "切换打击音效",
	["ui.settings.editor.shortcuts.toggle_hit_effects"] = "切换打击特效",
	["ui.settings.editor.shortcuts.toggle_sync_same_main_audio"] = "切换同主音轨同步",
	["ui.settings.editor.shortcuts.record"] = "录制",
	["ui.settings.editor.shortcuts.clear"] = "清空",
	["ui.settings.editor.shortcuts.none"] = "未设置",
	["ui.settings.editor.shortcuts.recording"] = "按下快捷键...",
