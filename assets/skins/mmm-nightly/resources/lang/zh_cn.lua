return {
	...
	["ui.file.overwrite.msg"] = "文件 %s 已经存在。您确定要覆盖它吗？",
    ["ui.file.name"] = "文件名",
    ["ui.file.type"] = "类型",
    ["ui.file.size"] = "大小",
    ["ui.file.date"] = "日期",
