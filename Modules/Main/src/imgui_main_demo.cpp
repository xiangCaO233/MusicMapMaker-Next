                              ...
                              VkSurfaceKHR surface, int width, int height)
{
    ...
    vkGetPhysicalDeviceSurfaceSupportKHR(
        g_PhysicalDevice, g_QueueFamily, surface, &res);
    if ( res != VK_TRUE ) {
...
static void FrameRender(ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data)
{
    ...
    VkResult err = vkAcquireNextImageKHR(g_Device,
                                         wd->Swapchain,
                                         UINT64_MAX,
...
int main(int, char**)
{
    ...
    auto asciiFontPath = SkinManager::instance().getFontPath("ascii");
    ...
    while ( !glfwWindowShouldClose(window) ) {
        ...
        // pair to create a named window.
        {
            ...
            ImGui::ColorEdit4(
                "clear color",
                (float*)&clear_color);  // Edit 4 floats representing a color
