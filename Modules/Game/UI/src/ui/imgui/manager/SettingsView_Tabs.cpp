...
void SettingsView::drawSoftwareSettings()
{
    ...
    if ( ImGui::CollapsingHeader(
             TR_CACHE("ui.settings.software.general").data(),
        ...
        changed |= ImGui::Checkbox(
            TR_CACHE("ui.settings.software.vsync").data(), &settings.vsync);
        ...
        if ( ImGui::Combo(
                 "##ThemeCombo", &theme, themes, IM_ARRAYSIZE(themes)) ) {
    ...
    if ( ImGui::CollapsingHeader(TR_CACHE("ui.settings.software.sync").data(),
                                 ImGuiTreeNodeFlags_DefaultOpen) ) {
        // 3. 同步模式
...
void SettingsView::drawVisualSettings()
{
    ...
    if ( ImGui::CollapsingHeader(
             TR_CACHE("ui.settings.visual.judgeline").data(),
             ImGuiTreeNodeFlags_DefaultOpen) ) {
        changed |= ImGui::SliderFloat(
    ...
    if ( ImGui::CollapsingHeader(
             TR_CACHE("ui.settings.visual.beat_line").data(),
             ImGuiTreeNodeFlags_DefaultOpen) ) {
        changed |= ImGui::SliderFloat(
    ...
    if ( ImGui::CollapsingHeader(TR_CACHE("ui.settings.visual.note").data(),
                                 ImGuiTreeNodeFlags_DefaultOpen) ) {
        changed |= ImGui::SliderFloat(
    ...
    if ( ImGui::CollapsingHeader(
             TR_CACHE("ui.settings.visual.background").data(),
             ImGuiTreeNodeFlags_DefaultOpen) ) {
    ...
    if ( ImGui::CollapsingHeader(TR_CACHE("ui.settings.visual.preview").data(),
                                 ImGuiTreeNodeFlags_DefaultOpen) ) {
        changed |= ImGui::SliderFloat(
    ...
    if ( ImGui::CollapsingHeader(TR_CACHE("ui.settings.visual.offset").data(),
                                 ImGuiTreeNodeFlags_DefaultOpen) ) {
        if ( ImGui::DragFloat(
...
void SettingsView::drawEditorSettings()
{
    ...
    if ( ImGui::CollapsingHeader(TR_CACHE("ui.settings.editor.behavior").data(),
                                 ImGuiTreeNodeFlags_DefaultOpen) ) {
        changed |= ImGui::Checkbox(
    ...
    if ( ImGui::CollapsingHeader(TR_CACHE("ui.settings.editor.sfx").data(),
                                 ImGuiTreeNodeFlags_DefaultOpen) ) {
